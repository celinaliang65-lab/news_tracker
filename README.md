...
| 項目 | 說明 |
|------|------|
| Spreadsheet ID | `1LR7yZlngjwlH-RMh3xLhi-vVQdi5rDdLdxMy4lvtwLk` |
| Sheet tab 名稱 | `觀察清單` |
| 必要欄位 | 代號、名稱、交易所 |
...
3. workflow `.yml` 的 env 區塊加入 `GOOGLE_CREDENTIALS: ${{ secrets.GOOGLE_CREDENTIALS }}`
...
*文件結束　建立者：Claude (Anthropic)　更新日期：2026/05/16*
